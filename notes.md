...
- [ ] **Bubbles:** Switch gray and blue bubble colors.
- [ ] **Bubbles:** Switch tail side.
...
- [ ] **Notifications:** Add text send / receive SFX.
- [ ] **Styling:** Move color settings under guide settings in Game Details.
- [ ] **Styling:** All Caps shrink / grow in player messages.
- [ ] **Styling:** Links should be bold, white, and underlined.
- [ ] **Styling:** Put player message label under the bubble.
- [ ] **Styling:** Remove bubble shadow.
- [ ] **Admin Features:** If `builder.html` has `?id=*` in the URL, load that specific game.
...
- [ ] **AI Button:** Add to primary color text box. Use AI to find hex codes based on phrases such as “NFL Saints” or “Beach sunrise.”
...
- [ ] **Tutorial:** Create standard “How to Play” verbiage.
