...
function updateObjectInspectorUi(node, link, copyText) {
  ...
  const BODY_LABELS = { stop: 'NOTES', bubble: 'GUIDE MESSAGE (OUTGOING STATEMENT OR QUESTION)', reply: 'PLAYER MESSAGE' };
  ...
  if (objectInsertBtn) {
    objectInsertBtn.hidden = isLinkSelected || !isGuideNode;
    objectInsertBtn.disabled = isLinkSelected || !isGuideNode;
  }
