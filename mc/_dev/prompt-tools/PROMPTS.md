...
| **TGB ANCHOR BOT** | `trig_01HKMKbnCyH6WLKuw7ZstY5b` | `8 8,20` | **the spec IS [anchor-bot.prompt.md](anchor-bot.prompt.md)**, read every run | `tgb_pull_anchor_events` |
