...
-- City: Buffalo, NY (fanbase city of the Bills); had zero rows in public.routes
-- Date: 2026-08-09
-- Shape: out_and_back, 10 stops
-- Distance / time: roughly 0.9 miles round trip, about 1 hour 15 minutes including
--   time standing at each stop.
-- Sports stop: stop 2, Bada Bing (42 W Chippewa St), a Chippewa Street bar named
--   in local coverage as the game-day gathering spot for Bills fans downtown.
-- Music stop: stop 3, the Tralf Music Hall (622 Main St), which has run live music
--   in the Theatre District since opening as the Tralfamadore Cafe in 1975.
-- Commercial ends: stop 1, Founding Fathers Pub (start, 75 Edward St) and stop 10,
--   Pearl Street Grill & Brewery (end, 76 Pearl St) -- both in the Theatre
--   District/financial-district core and about a five-minute walk apart.
-- Drawn from: Visit Buffalo's "A Self-Guided Walking Tour of Historic Buffalo"
--   (Buffalo on Foot) and the GPSmyCity Buffalo Introduction Walking Tour, both of
--   which anchor on City Hall, Old County Hall, St. Joseph Cathedral, the Guaranty
--   Building and Ellicott Square; the Theatre District leg (Shea's, the Tralf,
--   Chippewa Street's bars) is drawn from Explore Buffalo's Theatre District
--   coverage and Step Out Buffalo's bar guide; every address and fact below was
--   independently verified against a venue, Wikipedia, or local-history page.
-- Note: Main Street is the outbound spine (Theatre District south to Ellicott
--   Square); the return follows Pearl/Church/Franklin/Niagara Square back to
--   Pearl Street, so the outbound pavement is never retraced.
...
from public.tgb_import_walking_tour($tgb$
{
  "city": "Buffalo",
  "state": "NY",
  "title": "Chippewa to Franklin: A Buffalo Downtown Walk",
  "shape": "out_and_back",
  "blurb": "Ninety minutes through the Theatre District and Buffalo's civic core, from a memorabilia-packed dive bar to a Gothic cathedral and back, by way of a jazz room and the bar where the Bills game is always on.",
  "ai_model": "Anthropic Claude Sonnet 5",
  "stops": [
    {
      ...
      "zip": "14202",
      "description": "A Theatre District dive bar crammed floor to ceiling with presidential and pop-culture memorabilia; grab a beer, find your group, and start the walk.",
      "source_url": "https://visitbuffalo.com/businesses/founding-fathers-pub/"
    },
    {
      "name": "Bada Bing",
      "address": "42 W Chippewa St",
      "zip": "14202",
      "description": "This Chippewa Street sports bar is named locally as the place to watch the Bills on Sundays, its screens running from the front door to the back wall.",
      "source_url": "https://stepoutbuffalo.com/awesome-bars-to-watch-a-bills-game-in-buffalo-and-wny/"
    },
    {
      "name": "Tralf Music Hall",
      "address": "622 Main St",
      "zip": "14202",
      "description": "Opened in 1975 as the Tralfamadore Cafe, this intimate room has booked jazz and touring acts in the Theatre District for half a century.",
      "source_url": "https://www.buffalospree.com/arts_entertainment/sounds-of-the-city-the-tralf/article_9ffcd2bd-a3f6-5734-8560-bd26143f4515.html"
    },
    {
      "name": "Shea's Buffalo Theatre",
      "address": "646 Main St",
      "zip": "14202",
      "description": "Michael Shea's 1926 movie palace still runs under its original name and marquee, the Theatre District's grandest survivor.",
      "source_url": "https://en.wikipedia.org/wiki/Shea%27s_Performing_Arts_Center"
    },
    {
      "name": "Ellicott Square Building",
      "address": "295 Main St",
      "zip": "14203",
      "description": "Completed in 1896 for 3.5 million dollars, this Italian Renaissance office block was briefly the largest in the world, its interior court still lit by a glass rotunda.",
    ...
    },
    {
      ...
      "zip": "14202",
      "description": "Louis Sullivan's 1896 terracotta tower at Church and Pearl helped invent the skyscraper and still wears its original ornament almost unchanged.",
    ...
    },
    {
      ...
      "zip": "14202",
      "description": "This 1876 granite pile with the 270-foot clock tower served as Buffalo's city and county seat before City Hall was built, and now houses Erie County's courts.",
      "source_url": "https://en.wikipedia.org/wiki/County_and_City_Hall"
    },
    {
      "name": "St. Joseph Cathedral",
      "address": "50 Franklin St",
      "zip": "14202",
      "description": "Consecrated in 1855 for Buffalo's first Catholic bishop, this Gothic Revival cathedral has anchored Franklin Street for over 170 years.",
      "source_url": "https://en.wikipedia.org/wiki/St._Joseph_Cathedral_(Buffalo,_New_York)"
    },
    {
      "name": "Buffalo City Hall",
      "address": "65 Niagara Square",
      "zip": "14202",
      "description": "This 1931 Art Deco tower is Buffalo's civic centerpiece; its 28th-floor observation deck is free and open on weekdays if you want the view before heading back.",
      "source_url": "https://en.wikipedia.org/wiki/Buffalo_City_Hall"
    },
    {
      "name": "Pearl Street Grill & Brewery",
      "address": "76 Pearl St",
      "zip": "14202",
      "description": "Housed in an 1870s warehouse a few blocks from where you started, this four-floor brewpub is the place to sit down, order a flight, and call the walk finished.",
      "source_url": "https://pearlstreetgrill.com/contact/"
    }
  ]
}
$tgb$::jsonb);
