...
-- Distance / time: roughly 0.9 miles round trip, about 75-90 minutes including time
--   standing at each stop. The "out" leg runs west along the river on Mehring Way,
--   from Great American Ball Park past Smale Riverfront Park to Paycor Stadium; the
--   "return" leg comes back east one level up, along Freedom Way and Race St.
-- Sports stop: stop 2, Crosley Terrace (100 Joe Nuxhall Way), the bronze Reds Legends
--   statues outside Great American Ball Park.
-- Music stop: stop 8, the Andrew J. Brady Music Center (25 Race St), the riverfront
--   amphitheater between the Reds' and Bengals' stadiums.
-- Commercial ends: stop 1, Holy Grail Tavern & Grille (start), and stop 10, Tin Roof
--   (end) -- both sit on The Banks' restaurant row within about two minutes of walking.
-- Drawn from: Visit Cincy's "Explore Smale Riverfront Park" guide, Wander Cincinnati's
--   "Complete Guide to The Banks," the Cincinnati Parks feature list for Smale
--   Riverfront Park, and individual venue/landmark pages for every address below --
--   no single formal published walking-tour itinerary covers this exact stretch of
--   riverfront, so each stop is independently verified rather than lifted from one
--   source. Noted in full at the end.
...
from public.tgb_import_walking_tour($tgb$
{
  "city": "Cincinnati",
  "state": "OH",
  "title": "Bronze Legends and the Banks",
  "shape": "out_and_back",
  "blurb": "Ninety minutes along Cincinnati's riverfront between the Reds and the Bengals - bronze ballplayers, a Civil War monument, a carousel, and a stage where the music doesn't stop.",
  "ai_model": "Anthropic Claude Sonnet 5",
  "stops": [
    {
      ...
      "zip": "45202",
      "description": "This is the Holy Grail, the sports bar Reds and Bengals fans call their clubhouse a hundred yards from home plate; grab a seat, find your group, and start the walk whenever you're ready.",
      "source_url": "https://www.holygrailbanks.com/"
    },
    {
      "name": "Crosley Terrace (Reds Legends statues)",
      "address": "100 Joe Nuxhall Way",
      "zip": "45202",
      "description": "These four bronze Reds - Ted Kluszewski, Ernie Lombardi, Frank Robinson and Joe Nuxhall - play out an imaginary game on Crosley Terrace, a patch of grass built to the exact dimensions of the ballpark they actually played in.",
      "source_url": "https://en.wikipedia.org/wiki/Reds_Legends_of_Crosley_Field"
    },
    {
      "name": "Cincinnati Lager House",
      "address": "115 Joe Nuxhall Way",
      "zip": "45202",
      "description": "This brewpub on the river carries the name of Christian Moerlein, the German immigrant whose 19th-century brewery once made Cincinnati one of the biggest beer towns in America, and pours his old recipes again today.",
      "source_url": "https://cincylagerhouse.com/"
    },
    {
      "name": "Walnut Street Fountain & Steps",
      "address": "8 W Mehring Way",
      "zip": "45202",
      "description": "These stepped fountains sit at the foot of Walnut Street in Smale Riverfront Park, built where steamboats once tied up at the public landing, with the Ohio River and the old Roebling Suspension Bridge spread out ahead of you.",
      "source_url": "https://www.cincinnati-oh.gov/cincyparks/visit-a-park/find-a-parkfacility/smale-riverfront-park/smale-park-map-with-features/"
    },
    {
      "name": "Black Brigade Monument",
      "address": "166 W Mehring Way",
      "zip": "45202",
      "description": "This bronze relief and wall of carved names honors the Black Brigade, roughly seven hundred African American men rounded up at gunpoint in 1862 to dig Cincinnati's defenses, then kept digging as volunteers once the Army let them choose.",
      "source_url": "https://www.hmdb.org/m.asp?m=244949"
    },
    {
      "name": "Carol Ann's Carousel",
      "address": "2 Rosa Parks St",
      "zip": "45202",
      "description": "This hand-carved carousel spins year-round inside a glass pavilion in Smale Riverfront Park - a three-dollar ride and a bench worth taking before the walk turns back east.",
    ...
    },
    {
      ...
      "zip": "45202",
      "description": "This is Paycor Stadium, home of the Cincinnati Bengals since 2000 and the far end of this walk; circle the plaza, then head back east on the street one level up from the river.",
      "source_url": "https://www.hamiltoncountyohio.gov/government/departments/stadia_and_parking/paycor_stadium.php"
    },
    {
      "name": "Andrew J. Brady Music Center",
      "address": "25 Race St",
      "zip": "45202",
      "description": "This riverfront amphitheater opened in 2021 on the ground between the Reds' and Bengals' stadiums and now fills its 8,000-capacity lawn with touring acts most warm-weather nights.",
      "source_url": "https://bradymusiccenter.com/plan-your-visit/directions-parking"
    },
    {
      "name": "Yard House",
      "address": "95 E Freedom Way",
      "zip": "45202",
      "description": "This is Yard House, 250 taps deep and named for the yard-long glasses on the wall, a reliable stop for a pint and a plate on the walk back toward the start.",
      "source_url": "https://thebankscincy.com/attractions/yard-house/"
    },
    {
      "name": "Tin Roof",
      "address": "160 E Freedom Way",
      "zip": "45202",
      "description": "This is Tin Roof, a stage built for cover bands and karaoke most nights of the week; end the walk here, order a round, and stay for whoever's playing.",
      "source_url": "https://tinroofcincinnati.com/about/"
    }
  ]
}
$tgb$::jsonb);
