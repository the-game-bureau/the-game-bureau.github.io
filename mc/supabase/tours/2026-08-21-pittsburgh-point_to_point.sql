-- NFL walking tour: Pittsburgh (Pittsburgh Steelers fanbase city)
-- Date: 2026-08-21
-- Shape: point_to_point, 6 stops
-- Walk: about 1.2 miles, roughly 50 to 70 minutes including time standing at each stop
-- Spine: Penn Avenue and Sixth Street out of the Cultural District, across the Roberto Clemente
--   Bridge, and into the North Shore stadium district. Genuinely one way; the two ends sit on
--   opposite banks of the Allegheny River, so nobody is walking back the way they came.
-- Sports stop: the Roberto Clemente statue outside PNC Park's center field gate
-- Music stop: Heinz Hall for the Performing Arts, home of the Pittsburgh Symphony Orchestra
-- Commercial ends: START at the Original Oyster House in Market Square (Pittsburgh's oldest bar
--   and restaurant, dating to 1870), END at Federal Galley, a North Shore food hall two blocks
--   from PNC Park
-- Reused waypoint: the Original Oyster House is already in the library at wpid 195 (city
--   Pittsburgh, address 20 Market Square); this walk links it rather than duplicating it
-- Drawn from: Visit Pittsburgh's Cultural District and North Shore walking-tour guides, the
--   Pittsburgh Cultural Trust's own venue pages, Wikipedia for the Byham Theater, the Roberto
--   Clemente Bridge and the Clemente statue, and each venue's own site (Heinz Hall, Federal
--   Galley), all cited per stop below
-- ai_model: Anthropic Claude Sonnet 5
--
-- Pittsburgh held zero applied paths and no committed file in this folder, and unlike every
-- other city still at zero it had never been picked by this routine before, so it was the
-- clear pick this run. The route follows the same crossing that published North Shore walking
-- guides already use: out of the Cultural District up Sixth Street, over one of the Three
-- Sisters suspension bridges, and down into the ballpark district on the far bank. Total
-- distance runs a little past the usual one-mile target for this shape because the river
-- crossing itself is a fixed 884 feet with no shorter way across; noted here rather than
-- padded out to look tidier than it is.
...
from public.tgb_import_walking_tour($tgb$
{
  "city": "Pittsburgh",
  "state": "PA",
  "title": "The Sixth Street Crossing",
  "shape": "point_to_point",
  "blurb": "An hour from Pittsburgh's oldest bar to the ballpark, over one of the only matching trio of bridges in the country.",
  "ai_model": "Anthropic Claude Sonnet 5",
  "stops": [
    {
      ...
      "zip": "15222",
      "description": "Pittsburgh's oldest bar and restaurant, pouring drinks and oysters in Market Square since 1870; find your group here before heading out.",
      "source_url": "https://www.visitpittsburgh.com/directory/the-original-oyster-house/"
    },
    {
      "name": "Heinz Hall for the Performing Arts",
      "address": "600 Penn Ave",
      "zip": "15222",
      "description": "Home of the Pittsburgh Symphony Orchestra since 1971, built in 1927 as a movie palace called Loew's Penn Theatre; look up at the marquee before moving on.",
      "source_url": "https://www.pittsburghsymphony.org/pso_home/web/heinz-hall"
    },
    {
      "name": "Byham Theater",
      "address": "101 Sixth St",
      "zip": "15222",
      "description": "A 1903 vaudeville house later run as the Fulton movie theater, where Night of the Living Dead had its world premiere in 1968.",
      "source_url": "https://en.wikipedia.org/wiki/Byham_Theater"
    },
    {
      "name": "Roberto Clemente Bridge",
      "address": "Sixth St",
      "zip": "15222",
      "description": "One of the matching Three Sisters suspension bridges built in 1928, the only such trio in the country, closed to cars on game days so fans cross it on foot instead.",
      "source_url": "https://en.wikipedia.org/wiki/Roberto_Clemente_Bridge"
    },
    {
      "name": "Roberto Clemente Statue",
      "address": "115 Federal St",
      "zip": "15212",
      "description": "A twelve foot bronze of the Hall of Fame right fielder dropping his bat out of the batter's box, standing outside the center field gate the Pirates moved it to in 2001.",
      "source_url": "https://en.wikipedia.org/wiki/Statue_of_Roberto_Clemente_(Pittsburgh)"
    },
    {
      "name": "Federal Galley",
      "address": "200 Children's Way",
      "zip": "15212",
      "description": "A North Shore food hall of small kitchens built from shipping containers, the place to sit down with a plate once the walk is done.",
      "source_url": "https://federalgalley.org/"
    }
  ]
}
$tgb$::jsonb);
