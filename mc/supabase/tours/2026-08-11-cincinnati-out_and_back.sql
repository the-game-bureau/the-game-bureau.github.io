...
-- Distance / time: roughly 1.4 miles round trip, about 1 hour 30 minutes including
--   time standing at each stop. The spine is Findlay Market's neighborhood at the
--   north end and the Music Hall / Washington Park plaza five blocks south -- a real
--   published distance of about 9-10 minutes each way. The "out" leg heads south down
--   Vine St and a short jog to Main St through the Gateway Quarter; the "return" leg
--   comes back north up Elm St past Washington Park and Music Hall to Rhinegeist.
-- Stretched: the last hop, Music Hall back up to Rhinegeist Brewery, runs closer to
--   9 minutes than the ideal 5-8 -- Findlay Market and the Music Hall / Washington
--   Park plaza are OTR's two anchor clusters and there is no verifiable third-party
--   stop on the quieter stretch of Elm St between them.
-- Sports stop: stop 2, the Findlay Market Opening Day Parade Historical Marker
--   (116 W Elder St) -- not a stadium, the actual corner the Reds fan parade has
--   stepped off from since 1920.
-- Music stop: stop 3, Schwartz's Point Jazz & Acoustic Club (1901 Vine St), a
--   Euro-style jazz room at OTR's five-way Vine/McMicken/Findlay intersection.
--   Music Hall (stop 9) is the second music-flavored stop, included for its own sake.
-- Commercial ends: stop 1, Findlay Market (start) and stop 10, Rhinegeist Brewery
--   (end) -- both sit at the north end of the walk, about a 3-4 minute walk apart.
-- Drawn from: the GPSmyCity "Over-the-Rhine District Walking Tour" (Washington Park,
--   Music Hall, Graeter's, Findlay Market), the Findlay Market Opening Day Parade
--   historical marker records on HMDB.org and RemarkableOhio.org, and individual
--   venue listing pages for every address below.
...
from public.tgb_import_walking_tour($tgb$
{
  "city": "Cincinnati",
  "state": "OH",
  "title": "Findlay Market and Back: Vine Street's Jazz, Ice Cream and Opera House",
  "shape": "out_and_back",
  "blurb": "An out-and-back through Over-the-Rhine's two anchor plazas -- Findlay Market's Opening Day corner and the Music Hall / Washington Park green -- down Vine and Main through the Gateway Quarter and back up Elm, with a jazz club, ice cream and a century of Reds tradition along the way.",
  "ai_model": "Anthropic Claude Sonnet 5",
  "stops": [
    {
      "name": "Findlay Market",
      ...
      "zip": "45202",
      "description": "Ohio's oldest continuously operated public market, open since 1855 -- grab coffee or breakfast from a market stall and find your group before setting off.",
      "source_url": "https://www.findlaymarket.org/"
    },
    {
      "name": "Findlay Market Opening Day Parade Historical Marker",
      "address": "116 W Elder St",
      "zip": "45202",
      "description": "A 2020 marker at the spot where Findlay Market shopkeepers first organized a fan parade for the Cincinnati Reds in 1920, a tradition that still marches from this corner every Opening Day.",
      "source_url": "https://remarkableohio.org/marker/96-31-findlay-market-opening-day-parade-findlay-market-opening-day-parade/"
    },
    {
      "name": "Schwartz's Point Jazz & Acoustic Club",
      "address": "1901 Vine St",
      "zip": "45202",
      "description": "A tiny Euro-style jazz room tucked into a historic building at OTR's five-way Vine, McMicken and Findlay intersection, with live jazz, blues and Latin sets Thursday through Sunday nights.",
      "source_url": "https://thepointclub.weebly.com/"
    },
    {
      "name": "Graeter's Ice Cream",
      "address": "1401 Vine St",
      "zip": "45202",
      "description": "Cincinnati's own ice cream maker, hand-spun in small French pot freezers since 1870 -- this is the spot for a scoop of black raspberry chip.",
    ...
    },
    {
      ...
      "zip": "45202",
      "description": "A no-cover dive bar and stage that helped turn Main Street into OTR's music-venue row, sister room to the Woodward Theater next door.",
    ...
    },
    {
      ...
      "zip": "45202",
      "description": "A professional regional theatre staging contemporary and adventurous new work out of a converted OTR storefront.",
      "source_url": "https://ensemblecincinnati.org/about/"
    },
    {
      "name": "Know Theatre of Cincinnati",
      "address": "1120 Jackson St",
      "zip": "45202",
      "description": "A 99-seat black box theatre known for fringe and experimental work -- this is the turnaround point, so note it and head back north.",
      "source_url": "https://www.knowtheatre.com/about/"
    },
    {
      "name": "Washington Park",
      "address": "1230 Elm St",
      "zip": "45202",
      "description": "OTR's restored eight-acre green, with a bandstand and splash pad serving as Music Hall's front lawn.",
      "source_url": "https://washingtonpark.org/"
    },
    {
      "name": "Music Hall",
      "address": "1241 Elm St",
      "zip": "45202",
      "description": "An 1878 Venetian Gothic concert hall that is still home to the Cincinnati Symphony, Pops, Opera and Ballet.",
      "source_url": "https://www.cincinnatiarts.org/plan-your-visit/visit-music-hall"
    },
    {
      "name": "Rhinegeist Brewery",
      "address": "1910 Elm St",
      "zip": "45202",
      "description": "A massive taproom in a former Moerlein bottling plant with a rooftop and skee-ball -- sit down, order a beer, and call it a walk.",
      "source_url": "https://rhinegeist.com/visit-us/"
    }
  ]
}
$tgb$::jsonb);
