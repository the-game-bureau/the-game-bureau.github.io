...
-- City: Cleveland, OH (fanbase city of the Browns); had zero rows in public.routes
-- Date: 2026-08-16
-- Shape: out_and_back, 10 stops
-- Distance / time: roughly 1.6 miles round trip, about 1 hour 45 minutes including
--   time standing at each stop.
-- Sports stop: stop 2, Progressive Field (2401 Ontario St), home of the Guardians,
--   a block from the Gateway District where the walk starts.
-- Music stop: stop 5, House of Blues Cleveland (308 Euclid Ave), at the corner of
--   Euclid and East 4th Street.
-- Commercial ends: stop 1, Pickwick & Frolic Restaurant & Club (start, 2035 E 4th
--   St) and stop 10, Flannery's Pub (end, 323 Prospect Ave E) -- both sit on the
--   same short block of East 4th Street in the Gateway District, about a two
--   minute walk apart.
-- Drawn from: Cleveland Historical's "Downtown Architecture" walking tour (Public
--   Square, the Euclid Avenue corridor east past the Cleveland Trust Company
--   Building and the 5th Street Arcades, the Rose Building at Prospect and East
--   9th), the GPSmyCity "Cleveland Introduction" walking tour (Public Square,
--   Terminal Tower), VoiceMap's "Cleveland Past and Present" downtown tour
--   (Public Square as the starting point, the East 4th Street pedestrian
--   district), and individual venue and landmark pages for every address and
--   fact below.
-- Note: outbound runs from the Gateway District up through Public Square and out
--   Euclid Avenue to the Cleveland Trust Company Building (now Heinen's); the
--   return comes back a block south via Prospect Avenue and East 9th Street, so
--   the outbound pavement is never retraced. The two required stops, the
--   ballpark and the blues club, sit close enough to the start that neither
--   forced a detour off that spine.
...
from public.tgb_import_walking_tour($tgb$
{
  "city": "Cleveland",
  "state": "OH",
  "title": "The Ballpark, the Blues and the Bank with a Dome",
  "shape": "out_and_back",
  "blurb": "An out and back walk through Cleveland's Gateway District and the Euclid Avenue corridor, from a ballpark bar to a blues club housed in a converted bank, by way of the city's oldest cemetery and its oldest building on Public Square.",
  "ai_model": "Anthropic Claude Sonnet 5",
  "stops": [
    {
      "name": "Pickwick & Frolic Restaurant & Club",
      "address": "2035 E 4th St",
      "zip": "44115",
      "description": "This East 4th Street restaurant and cabaret club has anchored the Gateway District since 2004, with a martini bar, a champagne bar and a comedy stage under one roof; grab a seat, find your group, and start the walk here.",
      "source_url": "https://www.pickwickandfrolic.com/"
    },
    {
      "name": "Progressive Field",
      "address": "2401 Ontario St",
      "zip": "44115",
      "description": "Home of the Cleveland Guardians since 1994 and still known to longtime fans by its old name, Jacobs Field, this brick and steel ballpark rises right at the edge of the Gateway District you just left.",
      "source_url": "https://en.wikipedia.org/wiki/Progressive_Field"
    },
    {
      "name": "Terminal Tower",
      "address": "50 Public Square",
      "zip": "44113",
      "description": "Finished in 1930 and the tallest building outside New York City for decades, this fifty two story tower still stands over Public Square as the anchor of the Cleveland skyline.",
      "source_url": "https://en.wikipedia.org/wiki/Terminal_Tower"
    },
    {
      "name": "Old Stone Church",
      "address": "91 Public Square",
      "zip": "44113",
      "description": "Dedicated in 1855 on the northwest corner of Public Square, this is the oldest building still standing on the square and has held services here since Cleveland was a young city on the lake.",
    ...
    },
    {
      ...
      "zip": "44114",
      "description": "Opened in 2004 at the corner of Euclid and East 4th, this outpost of the national blues and roots chain books touring acts most nights of the week under its patchwork of folk art on the walls.",
      "source_url": "https://cleveland.houseofblues.com/"
    },
    {
      "name": "5th Street Arcades",
      "address": "530 Euclid Ave",
      "zip": "44115",
      "description": "Two Victorian shopping arcades from 1888 and 1911, connected into one glass roofed passage in 2000, this is the smaller cousin of the famous Cleveland Arcade a few blocks away.",
      "source_url": "https://www.5thstreetarcades.com/"
    },
    {
      "name": "Heinen's Downtown",
      "address": "900 Euclid Ave",
      "zip": "44115",
      "description": "This 1907 bank hall, built for the Cleveland Trust Company under a stained glass rotunda dome, now sells groceries under that same dome, so look up while you shop for a snack.",
      "source_url": "https://www.heinens.com/In-Store/Downtown/History-Architecture"
    },
    {
      "name": "Rose Building",
      "address": "2060 E 9th St",
      "zip": "44115",
      "description": "Built in 1902 for meatpacker Benjamin Rose at the corner of Prospect and East 9th, this was Ohio's largest office building on the day it opened and is now being converted into apartments and a hotel.",
      "source_url": "https://clevelandhistorical.org/items/show/1012"
    },
    {
      "name": "Erie Street Cemetery",
      "address": "2254 E 9th St",
      "zip": "44115",
      "description": "Opened in 1826 and still fenced off behind iron and a Gothic gateway on East 9th Street, this is Cleveland's oldest surviving cemetery, with pioneers and Civil War soldiers buried a few steps from where you now stand.",
      "source_url": "https://clevelandhistorical.org/items/show/319"
    },
    {
      "name": "Flannery's Pub",
      "address": "323 Prospect Ave E",
      "zip": "44115",
      "description": "Cleveland's Irish pub on East 4th Street since 1997, a block from Progressive Field and a block from where you started, this is the spot to end the walk with a pint and call it a night.",
