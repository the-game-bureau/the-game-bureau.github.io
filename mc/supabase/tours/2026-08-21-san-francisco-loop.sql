/*
  ...
  Distance and time: about 1.3 to 1.5 miles total walking, roughly 45 minutes of
    walking plus time at each stop, under two hours all in.
  Sports stop: stop 5, Joe DiMaggio Playground (651 Lombard St), the North Beach
    ballfield where Joe DiMaggio grew up playing before he ever wore pinstripes.
  Music stop: stop 6, The Saloon (1232 Grant Ave), San Francisco's oldest bar
    and a live blues venue since 1861. This waypoint already exists in the
    library (wpid 202) and the helper below will reuse that row rather than
    duplicating it.
  Commercial start and end: stop 1, Caffe Trieste (601 Vallejo St), and stop 10,
    Molinari Delicatessen (373 Columbus Ave), both open to the public with
    normal hours.
  Drawn from: freetoursbyfoot.com's self-guided North Beach walking tour for
    the general route and stop selection, plus the Wikipedia articles for City
    Lights Bookstore, Vesuvio Cafe, Molinari's, Saints Peter and Paul Church,
    Caffe Trieste, The Saloon and Columbus Tower (the Sentinel Building), and
    the San Francisco Recreation and Parks pages for Washington Square and Joe
    DiMaggio Playground, for addresses and history.
  Everything not stretched: every address below was verified against a real
    listing or that place's own page. Washington Square Park has no street
    number of its own; its address here, Filbert St and Stockton St, is the
    cross street address the city's own Recreation and Parks department uses
    for it, since a public square has no door to number.
*/
...
from public.tgb_import_walking_tour($tgb$
{
  "city": "San Francisco",
  "state": "CA",
  "title": "The Beats, the Bocce and the Blues of North Beach",
  "shape": "loop",
  "blurb": "A ten-stop loop through North Beach, from the espresso counter at Caffe Trieste to the deli case at Molinari's, by way of the ballfield where Joe DiMaggio grew up and the barroom where the Beat poets held court.",
  ...
  "stops": [
    {
      ...
      "zip": "94133",
      "description": "San Francisco's first espresso bar, pulling shots for poets and dockworkers alike since 1956; get your coffee, find your group, and head out whenever you are ready.",
      "source_url": "https://caffetrieste.com/"
    },
    {
      "name": "Washington Square Park",
      "address": "Filbert St and Stockton St",
      "zip": "94133",
      "description": "North Beach's own green square, laid out in 1847 and still the neighborhood's front lawn; cut across the grass toward the twin church spires on the far side.",
      "source_url": "https://sfrecpark.org/902/Washington-Square"
    },
    {
      "name": "Saints Peter and Paul Church",
      "address": "666 Filbert St",
      "zip": "94133",
      "description": "The twin-spired Italian Cathedral of the West, finished in 1924 and the church where Joe DiMaggio posed for wedding photos on the steps; look up at the spires, then follow the crowd toward the bakery line on Stockton.",
      "source_url": "https://en.wikipedia.org/wiki/Saints_Peter_and_Paul_Church,_San_Francisco"
    },
    {
      "name": "Liguria Bakery",
      "address": "1700 Stockton St",
      "zip": "94133",
      "description": "A single item bakery that has sold nothing but focaccia since 1911, baked fresh each morning until the pans run empty; grab a slice if there is any left and keep walking north.",
      "source_url": "https://en.wikipedia.org/wiki/Liguria_Bakery"
    },
    {
      "name": "Joe DiMaggio Playground",
      "address": "651 Lombard St",
      "zip": "94133",
      "description": "Named for the North Beach kid who learned the game on this field before he ever wore pinstripes, its bocce courts still draw a crowd most afternoons; watch a match at the fence, then double back toward Grant Avenue.",
      "source_url": "https://sfrecpark.org/565/Joe-DiMaggio-Playground"
    },
    {
      "name": "The Saloon",
      "address": "1232 Grant Ave",
      "zip": "94133",
      "description": "San Francisco's oldest surviving bar, pouring drinks on this corner since 1861 and still running live blues most nights; step inside for a song or two, then carry on south down Grant.",
      "source_url": "https://en.wikipedia.org/wiki/The_Saloon"
    },
    {
      "name": "City Lights Bookstore",
      "address": "261 Columbus Ave",
      "zip": "94133",
      "description": "The all paperback bookstore Lawrence Ferlinghetti opened in 1953, where Allen Ginsberg's Howl first went to print and the Beat poets held court upstairs; browse the shelves, then slip into the alley alongside it.",
      "source_url": "https://en.wikipedia.org/wiki/City_Lights_Bookstore"
    },
    {
      "name": "Vesuvio Cafe",
      "address": "255 Columbus Ave",
      "zip": "94133",
      "description": "The narrow, art covered bar next door to City Lights, open since 1948 and once so full of Kerouac that he skipped a ride to Big Sur to stay put; order something at the bar and take it upstairs if there is a seat.",
      "source_url": "https://en.wikipedia.org/wiki/Vesuvio_Cafe"
    },
    {
      "name": "Cafe Zoetrope",
      "address": "916 Kearny St",
      "zip": "94133",
      "description": "A green flatiron tower Francis Ford Coppola bought in 1972 to run his film studio out of, now a cafe pouring his family's wine beneath the movie memorabilia; have a glass on the patio before the last stretch of the walk.",
      "source_url": "https://en.wikipedia.org/wiki/Columbus_Tower_(San_Francisco)"
    },
    {
      "name": "Molinari Delicatessen",
      "address": "373 Columbus Ave",
      "zip": "94133",
      "description": "A family run Italian deli curing its own salami since 1896, the smell of it reaching the sidewalk before the door does; pick up something for the road and let Vallejo Street lead you the last few blocks home.",
      "source_url": "https://en.wikipedia.org/wiki/Molinari%27s"
    }
  ]
}
$tgb$::jsonb);
