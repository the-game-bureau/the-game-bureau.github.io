 ...
 * Distance and time: roughly 0.9 miles end to end, about 50 to 60 minutes including time spent at each stop
 * Sports stop: Birthplace of the Packers marker (stop 4), the corner where Curly Lambeau and George Calhoun founded the team on August 11, 1919
 * Music stop: Meyer Theatre (stop 3), the 1929 movie palace that still seats 1,011 for touring concerts
 * Commercial ends: The Depot Green Bay in the old railway depot (start, stop 1) and Hagemeister Park on the CityDeck riverfront (end, stop 6)
 * Sourced from: the Packers Heritage Trail (Wikipedia and the Historical Marker Database), the Wisconsin Historical Society National Register listing for Hotel Northland, and Downtown Green Bay's own venue pages, all cited per stop below
 * Written by: Anthropic Claude Sonnet 5
 *
 * The walk starts across the Fox River from downtown proper, in the old
 * Broadway-Dousman railyard, then crosses the Dousman Street bridge into the
 * historic core. From there it runs a short loop through the two blocks on
 * either side of Walnut Street where the Packers were founded, financed and
 * coached before finishing north at Cherry Street on the CityDeck waterfront,
 * a few blocks from where it began but not a walk anyone would call short.
 */
...
from public.tgb_import_walking_tour($tgb$
{
  "city": "Green Bay",
  "state": "WI",
  "title": "Titletown Before Lambeau",
  "shape": "point_to_point",
  "blurb": "Six blocks of downtown Green Bay carry more Packers history than the stadium ever will: the newsroom where the team was founded, the hotel where Lombardi took command, and the depot that used to send them off to away games. Start with breakfast at the old train depot and finish with a drink on the river.",
  "ai_model": "Anthropic Claude Sonnet 5",
  "stops": [
    {
      "name": "The Depot Green Bay",
      "address": "200 Dousman St",
      "zip": "54303",
      "description": "Grab breakfast or a beer inside the 1899 Chicago and North Western depot that once sent the Packers off on every road trip; find your group here before the walk begins.",
      "source_url": "https://thedepotrestaurantgb.com/"
    },
    {
      "name": "St. Willebrord Catholic Church",
      "address": "209 S Adams St",
      "zip": "54301",
      "description": "Vince Lombardi slipped in through the side door most weekday mornings during his ten years in Green Bay; look up at the twin spires he passed on his way to eight o'clock Mass.",
      "source_url": "https://en.wikipedia.org/wiki/St._Willebrord_Catholic_Church"
    },
    {
      "name": "Meyer Theatre",
      "address": "117 S Washington St",
      "zip": "54301",
      "description": "This 1929 movie palace still packs its 1,011 seats for touring concerts and comedy; check tonight's marquee before you walk on.",
      "source_url": "https://downtowngreenbay.com/go/meyer-theatre"
    },
    {
      "name": "Birthplace of the Packers",
      "address": "315 Cherry St",
      "zip": "54301",
      "description": "A green marker holds the corner where the old Press-Gazette newsroom once stood; Curly Lambeau and George Calhoun founded the team here on August 11, 1919.",
      "source_url": "https://explorehere.app/markers/kh7658zkwc57ftdh3nzyk9g1rn7fe5m7/birthplace-of-the-packers"
    },
    {
      "name": "Hotel Northland",
      "address": "304 N Adams St",
      "zip": "54301",
      "description": "Vince Lombardi held one of his earliest Green Bay press conferences inside this 1924 hotel, once NFL headquarters for three championship games; step into the restored lobby.",
      "source_url": "https://www.wisconsinhistory.org/record/national-register/NR2389/304-north-adams-street"
    },
    {
      "name": "Hagemeister Park",
      "address": "325 N Washington St",
      "zip": "54301",
      "description": "Named for the Packers' first home field, this waterfront restaurant on CityDeck is the place to sit down, order a round, and watch the Fox River go by.",
      "source_url": "https://downtowngreenbay.com/go/hagemeister-park"
    }
  ]
}
$tgb$::jsonb);
