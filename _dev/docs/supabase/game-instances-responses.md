...
Migration: [`supabase/migrations/20260625_game_instances_responses.sql`](../../../supabase/migrations/20260625_game_instances_responses.sql)
...
This project keeps SQL in `supabase/migrations/`. Apply the new file either via
...
The admin **Game Play Stats** panel
