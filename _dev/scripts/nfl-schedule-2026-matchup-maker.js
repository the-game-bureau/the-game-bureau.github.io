...
function buildPayloadForFanSide(matchup, venueInfo, fanSide, templatesByTeam) {
  ...
  const builderNotes = venueInfo.neutral
    ? `This is an NFL neutral-site takeover route built for ${fanTeam.fullName} fans in ${venueInfo.city} the day before kickoff.`
    : `This is an NFL away-game takeover route built for ${fanTeam.fullName} fans visiting ${TEAM_METADATA[matchup.homeCode].shortLabel}.`;
  ...
  return [
    {
      ...
      orderIndex: 100,
      builderNotes: config.builderNotes,
