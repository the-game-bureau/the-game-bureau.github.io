...
- **POSTING NEEDS A PAID TIER.** The free tier allows almost no writes. **This is the only account here that costs money**, which is worth knowing before wondering why a correct-looking setup returns 403 or 429.
