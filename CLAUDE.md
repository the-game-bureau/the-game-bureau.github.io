...
>
> **EVERY WAY OF NAMING IT RESOLVES HERE.** *Tape Room*, *soundtrack admin*, *soundtracks admin*, the live URL <https://thegamebureau.com/mc/soundtracks/admin/> or the Live Server one <http://127.0.0.1:5500/mc/soundtracks/admin/> — all of them are that one file, and none needs disambiguating before you start. **Reading and writing are different rules**: understand any of those names, but write only **TAPE ROOM** in new copy, comments and commit messages.
>
> | | |
> |---|---|
