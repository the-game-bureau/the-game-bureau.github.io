...
| [2026082104_public_socials_feed_paged.sql](mc/supabase/migrations/2026082104_public_socials_feed_paged.sql) | **/linkinbio/ shows 24 instead of 25 and its archive stops at 24.** Nothing breaks and nothing looks wrong, which is why it is easy to forget: the page deliberately omits `feed_offset` on a first page so it works against either version of the function. |
